...
| Task submission | `apps/api` | `POST /api/v1/control/execute` | `TaskLifecycleService.submit` | Yes: human command submission | Existing AIDE `/interactions/tasks` forwards to Gateway | B. CONSUMABLE THROUGH EXISTING GATEWAY |

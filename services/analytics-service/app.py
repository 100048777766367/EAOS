"""Architectural Metrics & Telemetry Aggregator deployable unit entry point."""
...
class analyticsServiceApp:
    """Deployable unit application controller for analytics-service."""

    def __init__(self) -> None:
        self.service_name: str = "analytics-service"

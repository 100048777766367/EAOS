...
class CapabilityMappingAggregate:
    ...
    def bind_realization(self, binding: RealizationBinding) -> None:
        ...
        self.bindings = [b for b in self.bindings if b.target_ref != binding.target_ref]
        self.bindings.append(binding)
        self.updated_at = datetime.now(UTC)

    def calculate_health(self, verified_targets: set[str]) -> CapabilityHealth:
        ...
        valid_count = sum(1 for b in self.bindings if b.target_ref in verified_targets)
